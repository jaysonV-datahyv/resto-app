                ...
                <div>
                    <div class="w-full">
                        <Panel header="Preview">
                            <div class="bg-cover bg-center min-h-fit text-white p-2 mb-3" style="background-image: url('/images/background_1.jpg')">
                                <div class="p-2 text-center" id="client-headings" style="text-shadow: 2px 2px 4px #000000;" v-html="sys_property_value">
...
const editRecord = async () => {
    ...
    try {
        const response = await $fetch(`${API_BASE_URL}/api/admin/page_content/update_system_property/1`, {
            method: "PUT",
            body: data,
            headers: {
